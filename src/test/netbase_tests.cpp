...
BOOST_FIXTURE_TEST_SUITE(netbase_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(netbase_splithost_test)
    {
        ...
        BOOST_CHECK(TestSplitHost("www.fecal.org", "www.fecal.org", -1));
        BOOST_CHECK(TestSplitHost("[www.fecal.org]", "www.fecal.org", -1));
        BOOST_CHECK(TestSplitHost("www.fecal.org:80", "www.fecal.org", 80));
        BOOST_CHECK(TestSplitHost("[www.fecal.org]:80", "www.fecal.org", 80));
        BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
        BOOST_CHECK(TestSplitHost("127.0.0.1:8884", "127.0.0.1", 8884));
        BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
        BOOST_CHECK(TestSplitHost("[127.0.0.1]:8884", "127.0.0.1", 8884));
        BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
        BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8884", "::ffff:127.0.0.1", 8884));
        BOOST_CHECK(TestSplitHost("[::]:8884", "::", 8884));
        BOOST_CHECK(TestSplitHost("::8884", "::8884", -1));
        BOOST_CHECK(TestSplitHost(":8884", "", 8884));
        BOOST_CHECK(TestSplitHost("[]:8884", "", 8884));
    ...
    BOOST_AUTO_TEST_CASE(netbase_lookupnumeric_test)
    {
        ...
        BOOST_CHECK(TestParse("127.0.0.1:8884", "127.0.0.1:8884"));
        BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
        BOOST_CHECK(TestParse("::", "[::]:65535"));
        BOOST_CHECK(TestParse("[::]:8884", "[::]:8884"));
        BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
