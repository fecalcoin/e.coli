...
#ifndef FECAL_TEST_SCRIPTNUM10_H
#define FECAL_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Fecal E.coli 0.10.0, for cross-comparison.
 */
public:
