...
const char* GetOpName(opcodetype opcode)
{
    ...
    /** SHIT START */
    case OP_SHIT_ASSET              : return "OP_SHIT_ASSET";
    /** SHIT END */
...
{
    if (this->size() > 30) {
        if ((*this)[25] == OP_SHIT_ASSET) { // OP_SHIT_ASSET is always in the 25 index of the script if it exists
            int index = -1;
            if ((*this)[27] == SHIT_R) { // Check to see if SHIT starts at 27 ( this->size() < 105)
                if ((*this)[28] == SHIT_V)
                    if ((*this)[29] == SHIT_N)
                        index = 30;
            } else {
                if ((*this)[28] == SHIT_R) // Check to see if SHIT starts at 28 ( this->size() >= 105)
                    if ((*this)[29] == SHIT_V)
                        if ((*this)[30] == SHIT_N)
                            index = 31;
            }
            ...
            if (index > 0) {
                ...
                if ((*this)[index] == SHIT_T) { // Transfer first anticipating more transfers than other assets operations
                    nType = TX_TRANSFER_ASSET;
                    return true;
                } else if ((*this)[index] == SHIT_Q && this->size() > 39) {
                    nType = TX_NEW_ASSET;
                    fIsOwner = false;
                    return true;
                } else if ((*this)[index] == SHIT_O) {
                    nType = TX_NEW_ASSET;
                    fIsOwner = true;
                    return true;
                } else if ((*this)[index] == SHIT_R) {
