...
This document provides guidelines for internationalization of the Fecal E.coli software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `fecal_en.ts` remains unchanged.
