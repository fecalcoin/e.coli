Fecal E.coli version *2.1.0* is now available!!
==============

  <https://github.com/RavenProject/Fecalcoin/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/RavenProject/Fecalcoin/commits/release_2.1.0>
