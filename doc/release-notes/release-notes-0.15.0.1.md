Fecal E.coli version *0.15.0.1* is now available from:

  <https://fecal.org/bin/fecal-core-0.15.0.1/>

and

  <https://fecalcoin.com/bin/fecal-core-0.15.0.1/>
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/fecal/).
