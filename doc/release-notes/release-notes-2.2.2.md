Fecal E.coli version *2.2.2* is now available!!
==============

  <https://github.com/RavenProject/Fecalcoin/releases/tag/v2.2.2>
...
To receive security and update notifications, please subscribe to:
  ...
  <https://fecalcoin.com/en/list/announcements/join/>
...
Fecal E.coli has been tested with macOS 10.14 Mojave, but it is recommended that *developers*
...
- Enhancements for Fecalcoin Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/RavenProject/Fecalcoin/commits/release_2.2.2>
...
- Most importantly - The Fecal Community!
- Tron Black
- Jesse Empey
- Jeremy Anderson
- Corbin Fox
