...
class TxnMallTest(RavenTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 SHIT:
        ...
        # First: use raw transaction API to send 1240 SHIT to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 SHIT coin each
        ...
        # Node0's balance should be starting balance, plus 50SHIT for another
        ...
        # Node0's total balance should be starting balance, plus 100SHIT for 
