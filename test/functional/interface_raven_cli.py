...
class TestRavenCli(RavenTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `fecal-cli getinfo`")
        ...
        self.log.info("Compare responses from `fecal-cli -getinfo` and the RPCs data is retrieved from.")
