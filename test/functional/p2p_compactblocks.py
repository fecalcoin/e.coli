...
# TestNode: A peer we use to send messages to fecald, and store responses.
...
class CompactBlocksTest(RavenTestFramework):
    ...
    # This test actually causes fecald to (reasonably!) disconnect us, so do this last.
    ...
    # Test that fecald requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for fecald to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # fecald will not send blocktxn responses for blocks whose height is
