...
find ${DISTNAME}/bin -type f -executable -exec ../fecalcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../fecalcoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/fecalcoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/fecalcoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
